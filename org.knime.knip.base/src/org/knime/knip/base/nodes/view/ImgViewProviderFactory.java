 ...
 */
public class ImgViewProviderFactory<T extends RealType<T> & NativeType<T>> implements CellViewProviderFactory {
    ...
    public CellViewProvider createCellView() {
        return new CellViewProvider() {
            ...
            public CellView getViewComponent() {
                if (m_view == null) {
                    m_view = (ImgViewer2)ViewerFactory.createImgViewer2(KNIMEKNIPPlugin.getCacheSizeForBufferedImages());
                }
