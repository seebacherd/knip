...
import org.knime.cellviewer.core.interfaces.RenderComponent;
 ...
 */
public class ImgViewer2 extends CellView {
     ...
     * @param nodeModel
     */
    public ImgViewer2(final EventService eventService) {
    ...
    /**
     * Adds the {@link ViewerComponent} to the {@link ImgViewer2}
     *
     * @param panel {@link ViewerComponent} to be set
     *
     * @param setEventService indicates weather the {@link EventService} of the {@link ImgViewer2} shall be set to the
     ...
     */
    @Override
    public void addViewerComponent(final org.knime.cellviewer.core.interfaces.ViewerComponent p) {
     ...
     */
    @Override
    public void update(final List<DataValue> v) {
       ImgPlusValue img = (ImgPlusValue)v.get(0);
       setImg(img.getImgPlus());
     ...
     */
    @Override
    public void setRenderComponent(final RenderComponent p) {
        // TODO Auto-generated method stub
